...
| Blocker-3-followup-2 | `manage-user` Edge Function fallback removal (acceptance: N days / zero fallback `log.warn` events) | 🔍 In Verification (pending query results) — [verification packet](../../../dev/active/api-rpc-readback-pattern/blocker-3-followup-2-verification-2026-05-01.md) · [draft PR](https://github.com/analytics4change/a4c-appsuite/pull/) |
