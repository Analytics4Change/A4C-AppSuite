...
> [!WARNING]
> **DEPRECATED: This document describes the Zitadel-based architecture**
>
> The A4C platform migrated from Zitadel to Supabase Auth in October 2025. This document is preserved for historical reference only.
>
> **For current architecture**, see:
> - `documentation/architecture/data/event-sourcing-overview.md` - CQRS/Event Sourcing patterns (current)
> - `documentation/architecture/authentication/supabase-auth-overview.md` - Current authentication (Supabase Auth)
> - `documentation/architecture/data/multi-tenancy-architecture.md` - Current multi-tenancy architecture
