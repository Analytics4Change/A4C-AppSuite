...
| [cross_tenant_access_grants_projection.md](infrastructure/reference/database/tables/cross_tenant_access_grants_projection.md) | VAR cross-org access (RLS shipped Phase 2) | `cross-tenant`, `var-contracts`, `authorization` | 650 |
