 ...
 * Generated: 2026-03-28T01:33:53.653Z
 *
...
export enum AnonymousSchema_4769 {
  RESERVED_TEXT = "text",
...
export enum AnonymousSchema_4797 {
  RESERVED_TEXT = "text",
  RESERVED_NUMBER = "number",
  DATE = "date",
  RESERVED_ENUM = "enum",
...
export interface UserAddressUpdatedEvent {
  ...
  'event_data': AnonymousSchema_2618;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface AnonymousSchema_2618 {
  'address_id': string;
  'user_id': string;
  'org_id'?: string;
  'label': string;
...
export interface UserAddressRemovedEvent {
  ...
  'event_data': AnonymousSchema_2650;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface AnonymousSchema_2650 {
  'address_id': string;
  'user_id': string;
  'org_id'?: string;
...
export interface UserPhoneUpdatedEvent {
  ...
  'event_data': AnonymousSchema_2699;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface AnonymousSchema_2699 {
  'phone_id': string;
  'user_id': string;
  'org_id'?: string;
  'label': string;
...
export interface ClientFieldDefinitionCreatedData {
  ...
  'field_key': string;
  'display_name': string;
  'field_type'?: AnonymousSchema_4769;
  'is_visible'?: boolean;
  'is_required'?: boolean;
...
export interface ClientFieldDefinitionUpdatedData {
  ...
  'display_name'?: string;
  'category_id'?: string;
  'field_type'?: AnonymousSchema_4797;
  'is_visible'?: boolean;
  'is_required'?: boolean;
  'validation_rules'?: Map<string, any>;
  'is_dimension'?: boolean;
