-- Migration: Fix notification_preferences table and column names in process_user_event()
--
-- Problem: The user.notification_preferences.updated handler referenced:
--   - Wrong table: notification_preferences_projection (should be user_notification_preferences_projection)
--   - Wrong column: org_id (should be organization_id)
--
-- Root cause: Bug introduced in 20260118023619_fix_user_phone_columns.sql while fixing phone columns

-- ============================================================================
-- Fix process_user_event() with correct table and column names
-- ============================================================================
...
BEGIN
  CASE p_event.event_type
    ...
    -- FIX: Correct table name (user_notification_preferences_projection) and column (organization_id)
    -- =========================================================================
    ...
    WHEN 'user.notification_preferences.updated' THEN
      ...
      -- FIX: Correct table name and column name
      INSERT INTO user_notification_preferences_projection (
        user_id,
        organization_id,  -- FIX: was 'org_id'
        email_enabled,
        sms_enabled,
        sms_phone_id,
        in_app_enabled,
      ...
      ON CONFLICT (user_id, organization_id) DO UPDATE SET  -- FIX: was 'org_id'
    ...
    -- =========================================================================
    -- Phone events
    -- user_phones table is user-global with columns: type, number (NOT phone_type, phone_number, org_id)
    -- =========================================================================
...
- user.notification_preferences.updated: Update notification settings (user_notification_preferences_projection)
...
- 2026-01-19: Fixed user.notification_preferences.updated - correct table (user_notification_preferences_projection)
              and column (organization_id not org_id)';


-- ============================================================================
-- Reprocess failed notification preferences events
-- ============================================================================
...
BEGIN
  -- Find and reprocess any failed user.notification_preferences.updated events
  FOR v_failed_event IN
    SELECT * FROM domain_events
    WHERE stream_type = 'user'
      AND event_type = 'user.notification_preferences.updated'
