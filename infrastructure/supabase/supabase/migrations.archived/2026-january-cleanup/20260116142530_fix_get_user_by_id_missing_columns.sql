-- Migration: Fix api.get_user_by_id() - remove non-existent columns
--
-- The function references r.permission_count and r.user_count from roles_projection,
-- but those columns don't exist. Remove them to match api.list_users() pattern.
