-- =============================================================================
-- Day 0 v2 Baseline Migration
-- =============================================================================
-- 
-- Purpose: Consolidates all migrations from 2024-01-01 through 2025-12-29
--          into a single clean baseline representing the complete schema.
--
-- This baseline includes:
--   - All tables, indexes, and constraints
--   - All RLS policies for multi-tenant isolation
--   - All functions (api.*, public.*)
--   - All triggers for event processing
...
--   - 20251229*.sql - RBAC cleanup phases (11 migrations)
--
-- Total: 26 migrations consolidated into this baseline
--
...
COMMENT ON FUNCTION "api"."create_role"("p_name" "text", "p_description" "text", "p_org_hierarchy_scope" "text", "p_permission_ids" "uuid"[], "p_cloned_from_role_id" "uuid") IS 'Create a new role with permissions. Supports optional p_cloned_from_role_id for role duplication audit trail. Enforces subset-only delegation.';
...
COMMENT ON FUNCTION "api"."emit_domain_event"("p_stream_id" "uuid", "p_stream_type" "text", "p_event_type" "text", "p_event_data" "jsonb", "p_event_metadata" "jsonb") IS 'Emit domain event with auto-calculated stream_version. Used by RPC functions like api.create_role.
Parameters:
...
COMMENT ON FUNCTION "api"."get_roles"("p_status" "text", "p_search_term" "text") IS 'List roles visible to current user. Global roles only visible to platform_owner. Uses SECURITY DEFINER for performance.';
...
COMMENT ON FUNCTION "api"."update_role"("p_role_id" "uuid", "p_name" "text", "p_description" "text", "p_permission_ids" "uuid"[]) IS 'Update role name/description and permissions. Enforces subset-only delegation for grants.';
...
COMMENT ON FUNCTION "public"."process_rbac_event"("p_event" "record") IS 'Process RBAC domain events and update projections. Handles role lifecycle and permission management.';
