...
-- Drop old function signatures to prevent ambiguity (idempotent)
...
-- ----------------------------------------------------------------------------
-- Source: sql/03-functions/event-processing/012-process-user-events.sql
-- ----------------------------------------------------------------------------
...
-- 2b. Get invitation by token (for accept-invitation Edge Function)
...
-- ----------------------------------------------------------------------------
-- Source: sql/06-rls/004-ou-management-policies.sql
-- ----------------------------------------------------------------------------
