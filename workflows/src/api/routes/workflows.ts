...
async function bootstrapOrganizationHandler(
  ...
  // Get Supabase admin client for event emission
  console.log('[Bootstrap] Getting Supabase client...');
  const supabaseAdmin = getSupabaseClient();

  // Note: UUID collision check removed - probability is 1 in 2^122
  // Temporal workflow ID uniqueness provides sufficient collision protection
