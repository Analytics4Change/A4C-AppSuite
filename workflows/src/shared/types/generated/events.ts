...
export enum BootstrapStepKey {
  CREATE_ORGANIZATION = "create_organization",
  GRANT_PERMISSIONS = "grant_permissions",
  SEED_FIELD_DEFINITIONS = "seed_field_definitions",
...
export interface ScheduleCreatedEvent {
  ...
  'event_data': ScheduleCreatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ScheduleUpdatedEvent {
  ...
  'event_data': ScheduleUpdatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ScheduleDeactivatedEvent {
  'stream_id': string;
  'stream_type': 'schedule';
  'event_type': 'schedule.deactivated';
  'event_data': ScheduleDeactivatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ScheduleDeactivatedData {
  'template_id': string;
  'organization_id': string;
  'reason'?: string;
  'additionalProperties'?: Map<string, any>;
...
export interface ScheduleReactivatedEvent {
  'stream_id': string;
  'stream_type': 'schedule';
  'event_type': 'schedule.reactivated';
  'event_data': ScheduleReactivatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ScheduleReactivatedData {
  'template_id': string;
  'organization_id': string;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ScheduleDeletedEvent {
  ...
  'event_data': ScheduleDeletedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ScheduleUserAssignedEvent {
  'stream_id': string;
  'stream_type': 'schedule';
  'event_type': 'schedule.user_assigned';
  'event_data': ScheduleUserAssignedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ScheduleUserAssignedData {
  'template_id': string;
  'user_id': string;
  'organization_id': string;
...
export interface ScheduleUserUnassignedEvent {
  'stream_id': string;
  'stream_type': 'schedule';
  'event_type': 'schedule.user_unassigned';
  'event_data': ScheduleUserUnassignedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ScheduleUserUnassignedData {
  'template_id': string;
  'user_id': string;
  'organization_id': string;
  'reason'?: string;
...
export interface UserClientUnassignedEvent {
  ...
  'event_data': UserClientUnassignedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface UserClientUnassignedData {
  'client_id': string;
  'organization_id': string;
  'reason'?: string;
  'additionalProperties'?: Map<string, any>;
...
export interface OrganizationDirectCareSettingsUpdatedEvent {
  'stream_id': string;
  'stream_type': 'organization';
  'event_type': 'organization.direct_care_settings_updated';
  'event_data': DirectCareSettingsUpdateData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface DirectCareSettingsUpdateData {
  'organization_id': string;
  'settings': DirectCareSettings;
  'previous_settings'?: DirectCareSettings;
  'additionalProperties'?: Map<string, any>;
}
...
export interface OrganizationBootstrapStepCompletedEvent {
  'stream_id': string;
  'stream_type': 'organization';
  'event_type': 'organization.bootstrap.step_completed';
  'event_data': OrganizationBootstrapStepCompletedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface OrganizationBootstrapStepCompletedData {
  'organization_id': string;
...
export interface ContactUserLinkedEvent {
  'stream_id': string;
  'stream_type': 'contact';
  'event_type': 'contact.user.linked';
  'event_data': ContactUserLinkData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ContactUserLinkData {
  'contact_id': string;
  'user_id': string;
  'organization_id': string;
...
export interface ContactUserUnlinkedEvent {
  'stream_id': string;
  'stream_type': 'contact';
  'event_type': 'contact.user.unlinked';
  'event_data': ContactUserUnlinkData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ContactUserUnlinkData {
  'contact_id': string;
  'user_id': string;
  'organization_id': string;
...
export interface ContactDesignationCreatedEvent {
  'stream_id': string;
  'stream_type': 'contact';
  'event_type': 'contact.designation.created';
  'event_data': ContactDesignationData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ContactDesignationData {
...
export interface ContactDesignationDeactivatedEvent {
  'stream_id': string;
  'stream_type': 'contact';
  'event_type': 'contact.designation.deactivated';
  'event_data': ContactDesignationDeactivationData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ContactDesignationDeactivationData {
  'designation': string;
  'organization_id': string;
  'additionalProperties'?: Map<string, any>;
}
...
export interface PermissionUpdatedEvent {
  ...
  'event_data': PermissionUpdatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface AccessGrantPolicyOverrideAppliedEvent {
  'stream_id': string;
  'stream_type': 'access_grant';
  'event_type': 'access_grant.policy_override_applied';
  'event_data': AccessGrantPolicyOverrideAppliedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface VarPartnershipCreatedEvent {
  'stream_id': string;
  'stream_type': 'var_partnership';
  'event_type': 'var_partnership.created';
  'event_data': VarPartnershipCreationData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface VarPartnershipCreationData {
...
export interface VarPartnershipUpdatedEvent {
  'stream_id': string;
  'stream_type': 'var_partnership';
  'event_type': 'var_partnership.updated';
  'event_data': VarPartnershipUpdateData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface VarPartnershipUpdateData {
  'partnership_type'?: string;
  'contract_number'?: string;
  'contract_end_date'?: string;
  'revenue_share_percentage'?: number;
...
export interface VarPartnershipTerminatedEvent {
  'stream_id': string;
  'stream_type': 'var_partnership';
  'event_type': 'var_partnership.terminated';
  'event_data': VarPartnershipTerminationData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface VarPartnershipTerminationData {
  'terminated_by': string;
  'termination_reason': string;
  'additionalProperties'?: Map<string, any>;
}

export interface VarPartnershipSuspendedEvent {
  'stream_id': string;
  'stream_type': 'var_partnership';
  'event_type': 'var_partnership.suspended';
  'event_data': VarPartnershipSuspensionData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface VarPartnershipSuspensionData {
  'suspended_by': string;
...
export interface VarPartnershipReactivatedEvent {
  'stream_id': string;
  'stream_type': 'var_partnership';
  'event_type': 'var_partnership.reactivated';
  'event_data': VarPartnershipReactivationData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface VarPartnershipReactivationData {
  'reactivated_by': string;
  'new_contract_end_date'?: string;
  'additionalProperties'?: Map<string, any>;
}

export interface AuditHighRiskActionLoggedEvent {
  'stream_id': string;
  'stream_type': 'platform_admin';
  'event_type': 'audit.high_risk_action_logged';
  'event_data': AuditHighRiskActionLoggedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface AuditHighRiskActionLoggedData {
  'action': string;
  'partnership_id'?: string;
  'permission_name'?: string;
  'override_reason'?: string;
  'termination_reason'?: string;
  'failed_grant_id'?: string;
  'applied_event_ids'?: string[];
  'cascade_event_ids'?: string[];
  'failure_index'?: number;
  'processing_error'?: string;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldDefinitionCreatedEvent {
  'stream_id': string;
  'stream_type': 'client_field_definition';
  'event_type': 'client_field_definition.created';
  'event_data': ClientFieldDefinitionCreatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldDefinitionCreatedData {
  'field_id': string;
  'organization_id': string;
  'category_id': string;
  'field_key': string;
...
export interface ClientFieldDefinitionUpdatedEvent {
  'stream_id': string;
  'stream_type': 'client_field_definition';
  'event_type': 'client_field_definition.updated';
  'event_data': ClientFieldDefinitionUpdatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldDefinitionUpdatedData {
  'field_id': string;
  'organization_id': string;
  'display_name'?: string;
  'category_id'?: string;
...
export interface ClientFieldDefinitionDeactivatedEvent {
  'stream_id': string;
  'stream_type': 'client_field_definition';
  'event_type': 'client_field_definition.deactivated';
  'event_data': ClientFieldDefinitionDeactivatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldDefinitionDeactivatedData {
  'field_id': string;
  'organization_id': string;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldDefinitionReactivatedEvent {
  'stream_id': string;
  'stream_type': 'client_field_definition';
  'event_type': 'client_field_definition.reactivated';
  'event_data': ClientFieldDefinitionReactivatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldDefinitionReactivatedData {
  'field_id': string;
  'organization_id': string;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldDefinitionDeletedEvent {
  'stream_id': string;
  'stream_type': 'client_field_definition';
  'event_type': 'client_field_definition.deleted';
  'event_data': ClientFieldDefinitionDeletedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldDefinitionDeletedData {
  'field_id': string;
  'organization_id': string;
  'field_key': string;
  'additionalProperties'?: Map<string, any>;
...
export interface ClientFieldCategoryCreatedEvent {
  'stream_id': string;
  'stream_type': 'client_field_category';
  'event_type': 'client_field_category.created';
  'event_data': ClientFieldCategoryCreatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldCategoryCreatedData {
  'category_id': string;
  'organization_id': string;
  'name': string;
  'slug': string;
...
export interface ClientFieldCategoryDeactivatedEvent {
  'stream_id': string;
  'stream_type': 'client_field_category';
  'event_type': 'client_field_category.deactivated';
  'event_data': ClientFieldCategoryDeactivatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldCategoryDeactivatedData {
  'category_id': string;
  'organization_id': string;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldCategoryReactivatedEvent {
  'stream_id': string;
  'stream_type': 'client_field_category';
  'event_type': 'client_field_category.reactivated';
  'event_data': ClientFieldCategoryReactivatedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldCategoryReactivatedData {
  'category_id': string;
  'organization_id': string;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldCategoryDeletedEvent {
  'stream_id': string;
  'stream_type': 'client_field_category';
  'event_type': 'client_field_category.deleted';
  'event_data': ClientFieldCategoryDeletedData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFieldCategoryDeletedData {
  'category_id': string;
  'organization_id': string;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ClientRegisteredEvent {
  ...
  'event_data': ClientRegistrationData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ClientRegistrationData {
  ...
  'discharge_plan_status'?: string;
  'placement_arrangement'?: string;
  'medicaid_id'?: string;
  'medicare_id'?: string;
  'primary_diagnosis'?: Map<string, any>;
  'secondary_diagnoses'?: Map<string, any>;
  'dsm5_diagnoses'?: Map<string, any>;
  'presenting_problem'?: string;
  'suicide_risk_status'?: string;
  'violence_risk_status'?: string;
...
export interface ClientInformationUpdatedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.information_updated';
  'event_data': ClientInformationUpdateData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientInformationUpdateData {
  'organization_id': string;
...
export interface ClientAdmittedEvent {
  ...
  'event_data': ClientAdmissionData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ClientDischargedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.discharged';
  'event_data': ClientDischargeData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ClientDischargeData {
  ...
  'discharge_diagnosis'?: Map<string, any>;
  'discharge_placement'?: string;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientPhoneAddedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.phone.added';
  'event_data': ClientPhoneData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientPhoneData {
  'organization_id': string;
  'phone_id': string;
  'phone_number': string;
  'phone_type'?: string;
...
export interface ClientPhoneUpdatedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.phone.updated';
  'event_data': ClientPhoneUpdateData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientPhoneUpdateData {
  'organization_id': string;
  'phone_id': string;
  'phone_number'?: string;
  'phone_type'?: string;
...
export interface ClientPhoneRemovedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.phone.removed';
  'event_data': ClientSubEntityRemovalData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientSubEntityRemovalData {
  'organization_id': string;
  'phone_id'?: string;
  'email_id'?: string;
  'address_id'?: string;
...
export interface ClientEmailAddedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.email.added';
  'event_data': ClientEmailData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ClientEmailUpdatedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.email.updated';
  'event_data': ClientEmailUpdateData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientEmailUpdateData {
  'organization_id': string;
  'email_id': string;
  'email'?: string;
  'email_type'?: string;
...
export interface ClientEmailRemovedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.email.removed';
  'event_data': ClientSubEntityRemovalData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientAddressAddedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.address.added';
  'event_data': ClientAddressData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ClientAddressUpdatedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.address.updated';
  'event_data': ClientAddressUpdateData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}
...
export interface ClientAddressRemovedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.address.removed';
  'event_data': ClientSubEntityRemovalData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientInsuranceAddedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.insurance.added';
  'event_data': ClientInsuranceData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientInsuranceData {
  'organization_id': string;
  'policy_id': string;
  'policy_type': string;
  'payer_name': string;
...
export interface ClientInsuranceUpdatedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.insurance.updated';
  'event_data': ClientInsuranceUpdateData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientInsuranceUpdateData {
  'organization_id': string;
  'policy_id': string;
  'payer_name'?: string;
  'policy_number'?: string;
...
export interface ClientInsuranceRemovedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.insurance.removed';
  'event_data': ClientSubEntityRemovalData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientPlacementChangedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.placement.changed';
  'event_data': ClientPlacementChangeData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientPlacementChangeData {
  'organization_id': string;
  'placement_id': string;
  'placement_arrangement': string;
  'start_date': string;
...
export interface ClientPlacementEndedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.placement.ended';
  'event_data': ClientPlacementEndData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientPlacementEndData {
  'organization_id': string;
  'end_date'?: string;
  'reason'?: string;
  'additionalProperties'?: Map<string, any>;
...
export interface ClientFundingSourceAddedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.funding_source.added';
  'event_data': ClientFundingSourceData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFundingSourceData {
  'organization_id': string;
  'funding_source_id': string;
  'source_type': string;
  'source_name': string;
...
export interface ClientFundingSourceUpdatedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.funding_source.updated';
  'event_data': ClientFundingSourceUpdateData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientFundingSourceUpdateData {
  'organization_id': string;
  'funding_source_id': string;
  'source_type'?: string;
  'source_name'?: string;
...
export interface ClientFundingSourceRemovedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.funding_source.removed';
  'event_data': ClientSubEntityRemovalData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientContactAssignedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.contact.assigned';
  'event_data': ClientContactAssignmentData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientContactAssignmentData {
  'organization_id': string;
  'assignment_id': string;
  'contact_id': string;
  'designation': string;
...
export interface ClientContactUnassignedEvent {
  'stream_id': string;
  'stream_type': 'client';
  'event_type': 'client.contact.unassigned';
  'event_data': ClientContactUnassignmentData;
  'event_metadata': EventMetadata;
  'additionalProperties'?: Map<string, any>;
}

export interface ClientContactUnassignmentData {
  'organization_id': string;
  'contact_id': string;
  'designation': string;
  'additionalProperties'?: Map<string, any>;
