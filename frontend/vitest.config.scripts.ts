...
export default defineConfig({
  test: {
    // Test files location. Only *.test.ts — NOT every file under __tests__/, which
    // would wrongly collect setup.ts (a setupFile) as a suite ("no test suite found").
    ...
    reporters: process.env.CI ? ['junit', 'json'] : ['verbose'],
