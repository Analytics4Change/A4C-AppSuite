  ...
  api: {
    ...
    Functions: {
      ...
      update_organization_direct_care_settings:
        | {
            Args: {
              p_enable_schedule_enforcement?: boolean
              p_enable_staff_client_mapping?: boolean
              p_org_id: string
            }
            Returns: Json
          }
  ...
  public: {
    Tables: {
      ...
      cross_tenant_access_grants_projection: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_cross_tenant_grants_consultant_org"
          ...
          {
            foreignKeyName: "fk_cross_tenant_grants_provider_org"
      ...
      impersonation_sessions_projection: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_impersonation_sessions_target_org"
      ...
      organizations_projection: {
        Row: {
          ...
          depth: number | null
          direct_care_settings: Json | null
          display_name: string | null
      ...
      permission_implications: {
        ...
        Relationships: [
          {
            foreignKeyName: "permission_implications_implies_permission_id_fkey"
            columns: ["implies_permission_id"]
            isOneToOne: false
            referencedRelation: "permissions_projection"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "permission_implications_permission_id_fkey"
      ...
      user_client_assignments_projection: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "user_client_assignments_projection_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      user_notification_preferences_projection: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_notification_prefs_org"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations_projection"
            referencedColumns: ["id"]
      ...
      users: {
        ...
        Relationships: [
          {
            foreignKeyName: "users_current_org_unit_id_fkey"
            columns: ["current_org_unit_id"]
            isOneToOne: false
            referencedRelation: "organization_units_projection"
            referencedColumns: ["id"]
          },
    ...
    Functions: {
      ...
      get_permission_scope: { Args: { p_permission: string }; Returns: unknown }
      get_staff_assigned_to_client: {
      ...
      handle_organization_direct_care_settings_updated: {
        Args: { p_event: Record<string, unknown> }
        Returns: undefined
      }
      ...
      handle_user_client_assigned: {
        Args: { p_event: Record<string, unknown> }
        Returns: undefined
      }
      handle_user_client_unassigned: {
        Args: { p_event: Record<string, unknown> }
        Returns: undefined
      }
      handle_user_created: {
      ...
      has_effective_permission: {
        Args: { p_permission: string; p_target_path: unknown }
        Returns: boolean
      }
      ...
      postgrest_pre_request: { Args: never; Returns: undefined }
